...
class WitherSkeleton extends Skeleton{
	...
	protected function getInitialSizeInfo() : EntitySizeInfo{
		return new EntitySizeInfo(2.01, 0.72);
	}
	...
	protected function registerGoals() : void{
		...
		$this->getGoalSelector()->addGoal(2, new MeleeAttackGoal(
			...
			function(Mob $_mob, Player $target) : void{
				$target->getEffects()->add(new EffectInstance(VanillaEffects::WITHER(), 10 * 20));
			}
		));
		$this->getGoalSelector()->addGoal(7, new RandomStrollGoal($this, 0.1, 8, 80));
